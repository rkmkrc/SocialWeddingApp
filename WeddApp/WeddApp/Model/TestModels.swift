...
struct TestModels {
    ...
    static var wedding = Wedding(id: 1, groom: groom, bride: bride, date: "01.01.2001", location: "\u{1F309} California \u{1F309}", welcomeMessage: "We are so happy to see you among us. Grateful to you. \n\u{1F33A}", album: Constants.album)
}
